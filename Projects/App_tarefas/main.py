...
def adicionar_item_tarefa(task):
    frame_tarefa = tk.Frame(canvas_interior, bg="white", bd=1, relief=tk.SOLID)

    label_tarefa = tk.Label(frame_tarefa, text=task, font=("Garamond", 16), bg="white", width=25, height=2, anchor="w")
...
# Carregar ícones
icon_editar = PhotoImage(file="icons8-edit-24.png")
icon_deletar = PhotoImage(file="icons8-delete-24.png")
